...
namespace Curso_Windows_forms
{
    public partial class Frm_ValidaCPF2 : Form
    {
        ...
        private void ValidaCPF2_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_Valida_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (MessageBox.Show("Você deseja realmente validar o CPF? ", "Mensagem de Validaçã ", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
